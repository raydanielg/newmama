...
<div class="module-header mb-4">
    <div class="header-info">
        ...
        <p class="text-muted">Daily record of all sales invoices and credit notes.</p>
    </div>
    <div class="header-actions">
        <a href="{{ route('admin.vouchers.sales-invoice.create') }}" class="btn btn-primary px-4 py-2 fw-bold shadow-sm">+ New Sales Invoice</a>
    </div>
</div>

<div class="content-card shadow-sm border-0 p-4 mb-4">
    <form method="GET" action="{{ route('admin.sales.day-book') }}" class="row g-3 align-items-end">
        <div class="col-md-3">
        ...
        <div class="col-md-4">
            ...
            <input name="q" value="{{ request('q') }}" type="text" placeholder="Search ref or description..." class="form-control border-light bg-light">
        </div>
        <div class="col-md-2">
        ...
        <table class="table table-hover align-middle mb-0">
            <thead class="bg-light">
                <tr>
                    ...
                    <th class="py-3 border-0 text-muted small uppercase fw-bold">Posting Date</th>
            ...
            <tbody class="border-top-0">
                ...
                @empty
                <tr><td colspan="5" class="text-center py-5 text-muted italic">No transactions found for the selected period.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
