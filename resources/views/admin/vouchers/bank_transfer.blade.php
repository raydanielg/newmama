...
<div class="module-header">
    <div class="header-info">
        <h3>Bank Transfer</h3>
        <p>Move funds between your own bank/cash accounts.</p>
    </div>
...
<div class="content-card">
    <form method="POST" action="{{ route('admin.vouchers.bank-transfer.store') }}" style="padding: 16px;">
        @csrf
        ...
        <div style="display:grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 14px;">
            ...
            <div>
                <label style="display:block; font-weight:600; margin-bottom:6px;">From Account</label>
            ...
            <div>
                <label style="display:block; font-weight:600; margin-bottom:6px;">To Account</label>
            ...
            <div style="grid-column: span 2;">
                ...
                <textarea name="narration" rows="2" placeholder="Purpose of transfer" style="width:100%; padding:10px 12px; border:1px solid #e5e7eb; border-radius:10px; resize:none;">{{ old('narration') }}</textarea>
            ...
            <div style="grid-column: span 2;">
                <button type="submit" class="btn-primary" style="width:100%; height:42px;">Post Transfer</button>
            </div>
        </div>
    </form>
</div>
