...
<div class="module-header">
    <div class="header-info">
        <h3>{{ $title }}</h3>
        <p>Cash and bank movements for selected period.</p>
    </div>
...
<div class="content-card" style="padding:16px; margin-bottom:14px;">
    <form method="GET" action="{{ route('admin.reports.payment-register') }}" style="display:flex; gap:10px; flex-wrap:wrap;">
        ...
        <a class="btn-icon" style="text-decoration:none;" href="{{ route('admin.reports.payment-register') }}">Reset</a>
    </form>
</div>
    ...
    <div class="table-responsive">
        <table class="admin-table">
            ...
            <tbody>
                ...
                @empty
                    <tr><td colspan="7" style="text-align:center; color:#6b7280; padding:18px;">No payments found.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
