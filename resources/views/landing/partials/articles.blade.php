<section class="landing-section articles-section">
    <div class="landing-container">
        <div class="articles-header animate__animated animate__fadeInUp">
            <div class="articles-header-left">
                <h2 class="landing-h2">Latest Articles</h2>
                <div class="articles-underline"></div>
            </div>
            <a href="{{ route('articles') }}" class="view-all-btn">View All</a>
        </div>
                        ...
                        <div class="article-content">
                            ...
                            <div class="article-meta">
                                ...
                                <span class="article-date">
                                    ...
                                    {{ \Carbon\Carbon::parse($article->published_at)->format('M d') }}
                                </span>
                            </div>
                        </div>
                    </div>
