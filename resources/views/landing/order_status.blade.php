...
<head>
    ...
    <title>Order Status – {{ config('app.name', 'Malkia Konnect') }}</title>
        ...
        <div class="card receipt-card">
            ...
            <div class="card-body p-4">
                ...
                @if($order->payment_status === 'unpaid')
                    ...
                    <a href="https://wa.me/{{ $settings['whatsapp_number'] ?? '255742710054' }}?text={{ urlencode('Hello Malkia Konnect, I want to confirm payment for Order #' . $order->order_number) }}" class="whatsapp-btn">
