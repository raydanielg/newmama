...
<body class="h-full flex items-center justify-center p-6">
    <div class="w-full max-w-[440px] animate__animated animate__fadeIn">
        <div class="bg-white/80 backdrop-blur-xl rounded-[2.5rem] shadow-[0_20px_50px_rgba(30,64,175,0.05)] border border-white p-8 md:p-12 relative overflow-hidden">
            ...
            <div class="text-center mb-10 relative">
                ...
                <h1 class="text-2xl font-black text-slate-900 tracking-tight mb-2">Join Mamacare</h1>
                <p class="text-slate-500 text-sm leading-relaxed">Create an account to start your personalized motherhood journey.</p>
            </div>
            ...
            <form action="{{ route('mother.register') }}" method="POST" class="space-y-5" onsubmit="return handleRegisterSubmit(this)">
                @csrf

                <!-- Full Name -->
                <div class="space-y-2">
                    <label class="block text-[13px] font-extrabold text-slate-800 ml-1">Full Name</label>
                ...
                <!-- Password -->
                <div class="space-y-2">
                    <label class="block text-[13px] font-extrabold text-slate-800 ml-1">Password</label>
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                ...
                <button type="submit" id="submitBtn" class="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-black py-4 rounded-2xl transition-all shadow-lg shadow-indigo-200 active:scale-[0.98] flex items-center justify-center gap-3 group relative overflow-hidden mt-4">
            ...
            <div class="mt-10">
                <div class="relative flex items-center justify-center">
                    ...
                    <span class="absolute bg-white px-4 text-[10px] font-black text-slate-300 uppercase tracking-widest">Or sign up with</span>
                </div>
