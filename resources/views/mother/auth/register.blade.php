...
<body class="h-full flex items-center justify-center p-4">
    <div class="w-full max-w-[440px] animate__animated animate__fadeInUp">
        <div class="bg-white rounded-[2rem] shadow-sm border border-slate-100 p-8 md:p-10">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-slate-500 mt-2 text-sm font-medium">Join Mamacare AI today</p>
            </div>
                ...
                <div>
                    ...
                    <div class="relative group">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            <i class="fas fa-user text-slate-400 group-focus-within:text-emerald-500 transition-colors"></i>
                        </div>
