...
<div class="w-full max-w-md" style="animation: simpleFadeIn 0.4s ease-out both;">
    <div class="bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden">
        ...
        {{-- Dynamic Header --}}
        <div id="auth-header" class="bg-gradient-to-br from-rosebrand-600 to-rosebrand-700 px-8 py-8 text-center">
            ...
            <p id="auth-subtitle" class="text-rosebrand-100 text-sm mt-1">Sign in to continue your motherhood journey</p>
        </div>
        ...
        <div class="p-8">
            ...
            <div id="login-section" class="form-section active">
                <form method="POST" action="{{ route('mother.login') }}" class="space-y-5" onsubmit="return handleSubmit(this)">
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-1.5">
                            ...
                            <button type="button" onclick="showSection('forgot-section')" class="text-sm font-medium text-rosebrand-600 hover:text-rosebrand-700 transition-colors">Forgot password?</button>
                        </div>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                            ...
                            <button type="button" onclick="togglePassword('login-password')" class="absolute inset-y-0 right-0 pr-3.5 flex items-center text-gray-400 hover:text-rosebrand-600 transition-colors">
                    ...
                    <div class="flex items-center justify-between">
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input type="checkbox" name="remember" id="remember_me" {{ old('remember') ? 'checked' : '' }}
                                class="w-4 h-4 rounded border-gray-300 text-rosebrand-600 focus:ring-rosebrand-500">
                ...
                <p class="text-center text-sm text-gray-500">
                    New to Mamacare?
                    <button onclick="showSection('register-section')" class="font-semibold text-rosebrand-600 hover:text-rosebrand-700 transition-colors">Create account</button>
                </p>
            </div>
            ...
            <div id="register-section" class="form-section">
                <form method="POST" action="{{ route('mother.register') }}" class="space-y-5" onsubmit="return handleSubmit(this)">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <button type="button" onclick="togglePassword('reg-password')" class="absolute inset-y-0 right-0 pr-3.5 flex items-center text-gray-400 hover:text-rosebrand-600 transition-colors">
                ...
                <p class="text-center text-sm text-gray-500">
                    ...
                    <button onclick="showSection('login-section')" class="font-semibold text-rosebrand-600 hover:text-rosebrand-700 transition-colors">Sign in</button>
                </p>
            </div>
